	...
	<body>
		...
		<div id="list-user" class="content scaffold-list" role="main">
			...
			<g:if test="${flash.errormessage}">
				<div class="errors" role="alert">${flash.errormessage}</div>
			</g:if>
			<table>
			<thead>
					<tr>
						...
						<g:sortableColumn property="coins" title="${message(code: 'user.coins.label', default: 'Coins')}" />
				...
				<g:each in="${userInstanceList}" status="i" var="userInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: userInstance, field: "coins")}</td>
